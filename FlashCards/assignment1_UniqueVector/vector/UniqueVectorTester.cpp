...
TEST_CASE( "Inserting elements into the vector at a certain position", "[insert_at_position]"){
	UniqueVector<int> testVector;
	int temp = -1;
...
// that the removal of an element results in a corresponding shift of the remaining elements left in the vector
TEST_CASE( "removing elements from the vector via position", "[remove_by_position]"){
